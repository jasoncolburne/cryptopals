...
digest = Jason::Math::Cryptography::Digest.new(:md4)
digest.state = mac.unpack('V*')

injected_message = ';admin=true'
padded_message = Jason::Math::Cryptography::Digest.pad('x' * 16 + message, :vax)
